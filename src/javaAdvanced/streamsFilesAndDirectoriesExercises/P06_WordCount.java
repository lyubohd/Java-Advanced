...
public class P06_WordCount {
    private static final String WORDS_INPUT_PATH = "src/javaAdvanced.streamsFilesAndDirectoriesExercises/resources/words.txt";
    private static final String TEXT_INPUT_PATH = "src/javaAdvanced.streamsFilesAndDirectoriesExercises/resources/text.txt";
